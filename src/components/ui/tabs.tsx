...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-tech-orange/10 p-1 text-muted-foreground border border-tech-orange/20",
      className
    )}
    {...props}
  />
