              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="hover:shadow-md transition-shadow cursor-pointer border-border hover:border-primary/40">
                  <CardContent className="p-4 text-center">
                    ...
                    <h3 className="font-semibold text-foreground mb-2">HEPRO Respons</h3>
                ...
                <Card className="hover:shadow-md transition-shadow cursor-pointer border-border hover:border-primary/40">
                  <CardContent className="p-4 text-center">
                    ...
                    <h3 className="font-semibold text-foreground mb-2">Digital Nattilsyn</h3>
                ...
                <Card className="hover:shadow-md transition-shadow cursor-pointer border-border hover:border-primary/40">
                  <CardContent className="p-4 text-center">
                    ...
                    <h3 className="font-semibold text-foreground mb-2">Varda Care</h3>
                ...
                <Card className="hover:shadow-md transition-shadow cursor-pointer border-border hover:border-primary/40">
                  <CardContent className="p-4 text-center">
                    ...
                    <h3 className="font-semibold text-foreground mb-2">Aula</h3>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      <h4 className="font-semibold text-foreground">👥 Pasientbehov & Opplæring</h4>
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-1 gap-2">
                          <Input 
                            ...
                            className="text-xs border-border focus:border-primary"
                            value={documentTitle}
                        ...
                        <div className="space-y-2">
                          <div className="border border-dashed border-border rounded-lg p-3 text-center hover:border-primary/50 transition-colors">
                            ...
                            <Button 
                              variant="outline" 
                              size="sm"
                              className="text-xs border-border text-foreground hover:bg-primary/10"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-3">
                        <span className="text-primary text-2xl">1️⃣</span>
                      </div>
                      <h4 className="font-semibold text-foreground">Planlegging</h4>
                      <p className="text-sm text-muted-foreground">DPIA, ROS, behovsanalyse</p>
                    </div>
                    <div className="text-center">
                      <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-3">
                        <span className="text-primary text-2xl">2️⃣</span>
                      </div>
                      <h4 className="font-semibold text-foreground">Implementering</h4>
                      <p className="text-sm text-muted-foreground">Fasevis utrulling</p>
                    </div>
                    <div className="text-center">
                      <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-3">
                        <span className="text-primary text-2xl">3️⃣</span>
                      </div>
                      <h4 className="font-semibold text-foreground">Opplæring</h4>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="border border-border rounded-lg p-4 bg-muted/30">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">DPIA Planleggingsverktøy</h4>
                        <p className="text-sm text-muted-foreground">Data Protection Impact Assessment</p>
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">Organisasjonstype</label>
                        <Select>
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">Datakategori</label>
                        <Select>
                          <SelectTrigger>
                  ...
                  <div className="border border-border rounded-lg p-4 bg-muted/30">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">ROS Analyseverktøy</h4>
                        <p className="text-sm text-muted-foreground">Risk & Opportunity Screening</p>
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">Risikonivå</label>
                        <Select>
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">Beregningsmetode</label>
                        <Select>
                          <SelectTrigger>
                  ...
                  <div className="border border-border rounded-lg p-4 bg-muted/30">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">Behovsanalyseverktøy</h4>
                        <p className="text-sm text-muted-foreground">Kartlegg pasient- og ansattbehov</p>
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">Fokusområde</label>
                        <Select>
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">Metode</label>
                        <Select>
                          <SelectTrigger>
                            <SelectValue placeholder="Velg metode" />
                          </SelectTrigger>
                  ...
                  <div className="bg-muted/30 border border-border rounded-lg p-4">
                    <h5 className="font-semibold text-foreground mb-3">Planleggingsstatus</h5>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="text-center">
                        <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-2">
                          <span className="text-primary text-lg">📊</span>
                        </div>
                        <p className="text-sm font-medium text-foreground">DPIA</p>
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm font-medium text-foreground">ROS</p>
                        <p className="text-xs text-muted-foreground">Ikke startet</p>
                      </div>
                      <div className="text-center">
                        <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-2">
                        ...
                        <p className="text-sm font-medium text-foreground">Behovsanalyse</p>
                        <p className="text-xs text-muted-foreground">Ikke startet</p>
                      </div>
                    </div>
                  </div>
